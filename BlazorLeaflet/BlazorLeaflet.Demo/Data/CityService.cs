...
public class CityService
{
    private readonly List<City> _cities = new()
    {
        new()
        {
            ...
            Coordinates = new(44.4268f, 26.1025f)
        },
        new()
        {
            ...
            Coordinates = new(52.2297f, 21.0122f)
        },
        new()
        {
            CoatOfArmsImageUrl =
                "https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Oslo_komm.svg/1200px-Oslo_komm.svg.png",
            Name = "Oslo",
            Country = "Norway",
            Description = "Oslo is the capital of Norway, also called <b>Oslo</b> in norwegian.",
            Coordinates = new(59.9139f, 10.7522f)
        }
    };
